...
.flip-box-back {
  ...
  <li><a href="Usersdb.jsp">Users Database</a></li>
        ...
        try{
            ...
            while(rs.next())
            {
                int prodid=rs.getInt(8);
                String mn=rs.getString(2);
                //String ct=rs.getString(3);
                String sp=rs.getString(4);
              out.println("<td>"+ "<div class='flip-box'><div class='flip-box-inner'><div class='flip-box-front'><img src='"+rs.getString(6)+"' width=298 height=198></div>"
                        + " <div class='flip-box-back'>Company :"+ rs.getString(1)+"<hr><br>Model Name:"+mn+"<input type='hidden' value='"+mn+"' name='model'><br>Price :"+sp+"<input type='hidden' name='price' value='"+sp+"'><hr>Description :"+rs.getString(7)+"<hr>"+ "Enter Quantity :<input type='number' value='1' id='qt' name='qt1'><hr><br><form action='Delete_prod.jsp' method='post'><input type='hidden' value='"+prodid+"' name='pid' id='pid"+i+"'><button class='button button2'>Remove <i class='fa fa-trash-o'></i></button> </form><form action='UpdateProduct.jsp' method='post'><input type='hidden' value='"+prodid+"' name='pid' id='pid"+i+"'><button class='button button2'>Update </button></form></div></div></div></td>");
