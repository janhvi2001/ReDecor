  ...
  <li><a href="logout.jsp">Logout</a></li>
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                out.println("<td>"+ "<div class='flip-box'><div class='flip-box-inner'><div class='flip-box-front'><form action='cart.jsp' method='post'><img src='"+rs.getString(5)+"' width=298 height=198></div>"
                        + " <div class='flip-box-back'>Company :"+ rs.getString(1)+"<hr><br>Model Name:"+mn+"<input type='hidden' name='model' value='"+mn+"'><br>Price :"+sp+"<input type='hidden' name='price' value='"+sp+"'><hr>Description :"+rs.getString(6)+"<hr>"
